...
android {
    ...
    defaultConfig {
        applicationId = "com.dd3boh.grooveum"
        minSdk = 26
        targetSdk = 35
        versionCode = 40
        versionName = "0.7.6"
    ...
    buildTypes {
        release {
            ...
            resValue("string", "app_name", "Grooveum")
        }
        debug {
            applicationIdSuffix = ".debug"
            resValue("string", "app_name", "Grooveum Debug")
        }
        ...
        create("userdebug") {
            ...
            resValue("string", "app_name", "Grooveum UserDebug")
        }
    }
...
// build variants and stuff
    ...
    productFlavors {
        ...
        create("universal") {
            ...
            resValue("string", "app_name", "Grooveum Universal")
        }
        // arm64 only
        create("arm64") {
            dimension = "abi"
            ...
            resValue("string", "app_name", "Grooveum Arm64")
        }
        // x86_64 only
        create("x86_64") {
            dimension = "abi"
            ...
            resValue("string", "app_name", "Grooveum x86_64")
        }
    }
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                val outputFileName = "Grooveum-${variant.versionName}-${variant.baseName}.apk"
